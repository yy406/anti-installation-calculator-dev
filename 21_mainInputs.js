// プルダウンで参照するリスト
const options = ["", "三式弾", "三式弾改", "三式弾改二", "九一徹甲", "一式徹甲", "一式徹甲改", "WG", "四式噴進", "四式噴進集中", "二式迫撃", "二式迫撃集中", "大発", "陸戦隊", "特大発", "士魂", "M4A1", "装甲艇", "武装大発", "2号アフリカ", "ホニ", "3号アフリカ", "チハ", "チハ改", "3号J型", "特二内火", "特四内火", "特四内火改", "歩兵", "チハ戦車", "チハ改戦車", "歩兵チハ改", "気球", "水戦/爆", "艦爆", "噴式機"]
